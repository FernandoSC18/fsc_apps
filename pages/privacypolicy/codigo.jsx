...
export default function Codigo (props) {
    ...
    const AreaHead = () => {
        return (  
            <Head>
                <meta charSet="utf-8" />
                <title>Código - privacy policy</title> 
        ...
        return (  
            <div>       
                <Title
                    color={'#ff8800'}
                    background={'#383838'}
                    text={'Política de privacidad: Código'}
                /> 
                <Container>       
                    <div className="parrafo">  
                        <br/>   
                        <p>Fecha de Actualización 16 de Junio del 2022</p> 
                    </div> 
                    <br/>   
                    <div className="parrafo">  
                        <br/>   
                        <p><b> Código entiende la importancia de tu privacidad </b> y, por lo tanto, la aplicación de Código:
                            <br/>    
                            <br/>    
                            ...
                            <br/> 
                            <br/> 
                            La aplicacion de Código es la única responsable del contenido mostrado en esta aplicación.
                            <br/> 
                            <br/> 
                            Esta política de privacidad solo aplica para Código y está sujeta a cambios y actualizaciones con el fin de cumplir con los derechos de privacidad de los usuarios, por lo que debe ser revisada periódicamente.                        
                            <br/> 
                            <br/> 
